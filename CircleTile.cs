...
public class CircleTile : MonoBase, ITile {
	private Mesh _mesh;
	...
	{
		return Shape.CircleContains (this.transform, this._mesh, point);
	}
	
	public Vector3 GetContainedPoint ()
	{
		return Shape.GetRandomPoint (this.transform, this._mesh, Shape.CircleContains);
	}
